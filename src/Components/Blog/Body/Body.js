...
export const BlogBody = () => {
   ...
   const [linksProjects, setLinksProjects] = useState({
      title:   '',
      url:     'https://ideasearchgif.netlify.app',
   })
      ...
      <div className='mt-8 bg-secondary-variant'>
         <div className='container'>
            <div className='row position-relative top-0 top-md-nem-3'>
               ...
               <BlogBodyCard route={'https://ideasearchgif.netlify.app'} porcentaje={75} title={'React'} icon={FaReact} description={'Una de mis herramientas favoritas para el front end, es la primera librería que empece a estudiar a fondo'} />
