      ...
      <div className='mt-8 bg-secondary-variant'>
         <div className='container'>
            <div className='row position-relative top-0 top-md-nem-3'>
               ...
               <BlogBodyCard route={'https://iniciarweb.online/gif-expert-app/'} porcentaje={75} title={'React'} icon={FaReact} description={'Una de mis herramientas favoritas para el front end, es la primera librería que empece a estudiar a fondo'} />
               ...
               {/* <div className="col-3 mb-4 text-center">
                  <div className="shadow border rounded-3 bg-secondary-variant d-flex align-items-center justify-content-center" style={{ height: '281px' }}>
